  ...
  return (
    <Container>
      ...
      <Header>
        ...
        <label>Nova {type === 'income' ? 'Receita' : 'Despesa'}</label>
      ...
      {repeat && (
        ...
        // </RepeatModal>
        <div>
          <TextField placeholder="Repetir" variant="standard" type='number' defaultValue={2}/>
          <Select defaultValue="default" variant="standard">
            <MenuItem value="default">Semanas</MenuItem>
